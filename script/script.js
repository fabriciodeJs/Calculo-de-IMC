...
function resultado(imc) {
    ...
    if (imc <= 18.5) {
        ...
        return s.innerHTML = 'Seu IMC:' + imc +', Abaixo do Peso';
    } else if (imc <= 24.9) {
        b.style.transition = '2s'
        b.style.backgroundColor = 'green'
        s.style.color = 'black';
        s.style.fontWeight= 'bold';
        return s.innerHTML = 'Seu IMC: ' + imc + ', Peso Normal';
    } else if (imc <= 29.9) {
        b.style.transition = '2s'
        b.style.backgroundColor = 'rgba(28, 212, 77, 0.622)';
        s.style.color = 'black';
        s.style.fontWeight= 'bold';
        return s.innerHTML = 'Seu IMC: ' + imc + ', Sobrepeso';
    } else if (imc <= 34.9) {
        b.style.transition = '2s'
        b.style.backgroundColor = 'rgb(202, 99, 99)';
        s.style.color = 'black';
        s.style.fontWeight= 'bold';
        return s.innerHTML = 'Seu IMC: ' + imc + ', Obsidade Grau 1';
    } else if (imc <= 39.9) {
        b.style.transition = '2s'
        b.style.backgroundColor = 'rgb(214, 64, 64)';
        s.style.color = 'black';
        s.style.fontWeight= 'bold';
        return s.innerHTML = 'Seu IMC: ' + imc + ', Obsidade Grau 2';
    } else {
        b.style.transition = '2s'
        b.style.backgroundColor = 'rgb(244, 0, 0)';
        s.style.color = 'black';
        s.style.fontWeight= 'bold';
        return s.innerHTML = 'Seu IMC: ' + imc + ', Obsidade Grau 3';
    }
